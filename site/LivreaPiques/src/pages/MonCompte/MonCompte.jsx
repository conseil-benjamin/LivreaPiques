...
function MonCompte() {
    ...
    const [isManager, setIsManager] = useState(false); // Ajout du state pour le statut manager
    ...
    useEffect(() => {
        ...
        // Vérification du statut manager
    ...
    return (
        <div className="profile-page">
            ...
            <div className="profile-content">
                ...
                <div style={{width: "100%", display: "flex", alignItems: "center", justifyContent: "center", margin: "2em 0 1em"}}>
