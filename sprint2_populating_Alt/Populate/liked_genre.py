...
def traitement_data():
    ...
    data_transformed.columns = ['username', 'genre_name']

    # enlever tout la partis aprés le @ dans username
    data_transformed['username'] = data_transformed['username'].str.split('@').str[0]
